...
const cookiesSchema = z.object({
                                   ...
                                   name: z.string().optional().describe('Cookie 名称（get/set/delete 必填）'),
                                   domain: z.string().optional().describe('域名过滤（get/clear）'),
                                   path: z.string().optional().describe('路径过滤（get）或设置路径（set）'),
                                   secure: z.boolean()
                                            .optional()
                                            .describe('只返回 secure cookies（get）或设置 secure 属性（set）'),
                                   ...
                                   sameSite: z.enum(['Strict', 'Lax', 'None'])
                                              .optional()
                                              .describe('SameSite 属性（set）'),
                                   expirationDate: z.number().optional().describe('过期时间戳（set）'),
                                   output: z.string()
                                            .optional()
                                            .describe('输出文件路径（get）。若指定，cookies 导出为 JSON 文件'),
                               })
